...
**Install** — download the latest `*-installer.exe` from [Releases](https://github.com/YeBai466/Better-Download-Manager/releases). To update, just run the new installer over the top; your download history and settings live in `%AppData%\BDownloadManager` and survive updates and uninstalls.
