...
**数据留存**
- 所有数据都只在你本机内传递与使用。扩展本身不在云端保存任何东西。
...
**What we do NOT do**
- We do not send any data to any remote server, third party, or the developer.
- No analytics, tracking, advertising, or profiling.
- We do not read or modify the content of the web pages you visit.
- We do not load or execute any remote code.
- We do not sell or share any data.

**Retention**
- All data stays on your machine. The extension stores nothing in the cloud.
